import 'file:///C:/Users/vinayak/Desktop/iblood/lib/blood_thumbnail.dart';
...
class RecentUpdateListWidget extends StatelessWidget {
  ...
  const RecentUpdateListWidget({
    Key key, this.receiverName, this.receiverAge, this.receiverSex, this.receiverDistance, this.postedAtTime,this.bloodgroup
  }) : super(key: key);
      ...
      child: Row(
        ...
        children: <Widget>[
          Padding(
            ...
            child: BloodGroupThumbnailWidget(bloodGroup: bloodgroup,),
          ),
          Column(
